const questions = [
  {
    ...
    description: [
      `Det var 1974 som antalet gäster till Nobelfesten vuxit så pass mycket
            ...
            Det var dock inte första gången middagen flyttats till Blå Hallen utan där har den
            även ägt rum bl.a under 50-års jubileumet 1951.`,
    ],
  },
  {
    question: `Blå Hallen är ett av Stadshusets mest berömda rum. Den har har en yta på 1500 kvadratmeter och är starkt influerad
        av italensk renesans vilket tydligt speglas i bl.a pelargången som  omringar hallen.
